...
export function parseAuditHTML(htmlString) {
  ...
  const excludedTitles = [
    ...
    "TRANSFER CREDIT: COURSE WORK THAT APPEARS HERE WILL NOTAPPLY TO ANY DEGREE REQUIREMENTS.",
    "GENERAL GRADUATION REQUIREMENTS(MINIMUM HOURS: 126)",
    "COURSE WORK WHICH MAY BE LIMITED OR EXCLUDED IN MEETINGGRADUATION REQUIREMENTS",
    "COMPUTER SCIENCE & ENG - TECH/DIRECT/TARGETED ELECTIVES* SOFTWARE ENGINEERING OPTION *"
  ];
